...
use syn::{
    parse_macro_input, Attribute, Expr, ExprArray, ExprLit, Ident, Lit, Token, Type, Visibility,
};
...
#[proc_macro]
pub fn mutself(input: TokenStream) -> TokenStream {
    ...
    if let Some(first) = first {
        ...
        let section_name = proc_macro2::Literal::byte_string(b".mutself");
